      ...
      <div className="bg-slate-900 text-white rounded-2xl max-w-3xl w-full shadow-2xl overflow-hidden my-auto max-h-[92vh] flex flex-col animate-in fade-in zoom-in-95 duration-150 relative border border-slate-800">
        ...
        <div className="bg-slate-900 text-white px-5 sm:px-6 py-3.5 flex items-center justify-between no-print flex-shrink-0 sticky top-0 z-20 border-b border-slate-800 shadow-sm">
          ...
          <div className="flex items-center space-x-1.5 sm:space-x-2">
            ...
            <button
              type="button"
              onClick={handlePrint}
              className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold shadow-xs transition-colors cursor-pointer active:scale-95"
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 text-xs text-slate-300 print:text-slate-600">
            ...
            <div>
              <span className="font-bold text-slate-200 print:text-slate-700">{language === 'my' ? 'ငွေထုတ်ယူနည်း' : 'Payout Method'}: </span>
            ...
            {partner && (
              <div className="col-span-2">
                <span className="font-bold text-slate-200 print:text-slate-700">{language === 'my' ? 'မိတ်ဖက် ကွန်ရက်' : 'Partner Channel'}: </span>
                <span className="text-slate-300 print:text-slate-800">{language === 'my' ? `${partner.nameMm} (${partner.nameEn})` : partner.nameEn} ({partner.swiftCode || partner.code})</span>
              </div>
            )}
        ...
        <div className="bg-slate-950 border-t border-slate-800 px-5 sm:px-6 py-3 flex flex-wrap items-center justify-between gap-2 no-print flex-shrink-0">
          ...
          <div className="flex items-center space-x-2">
            <button
              type="button"
              onClick={handleOpenNewTab}
              className="px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold flex items-center space-x-1.5 border border-slate-700 shadow-2xs transition-colors cursor-pointer"
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-semibold shadow-sm transition-colors cursor-pointer"
            >
