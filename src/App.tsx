...
const MainLayout: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-[#b2e0d4] text-slate-900 flex flex-col font-sans selection:bg-blue-600 selection:text-white overflow-hidden">
      {/* Header */}
      <Header 
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Content Container */}
        <main className="flex-1 overflow-y-auto p-4 sm:p-5 lg:p-6 min-w-0 bg-[#b2e0d4]">
...
class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-[#b2e0d4] text-slate-900 flex flex-col items-center justify-center p-6 text-center font-sans">
